...
public class AcademicoException extends Exception {
...
public class PreRequisitoNoAprobadoException extends AcademicoException {
...
public class HorarioConflictivoException extends AcademicoException {
...
public class CupoLlenoException extends AcademicoException {
...
public class EstudianteNoEncontradoException extends AcademicoException {
...
public class ColaDeEsperaVaciaException extends AcademicoException {
...
public class PilaDeshacerVaciaException extends AcademicoException {
...
public class ArchivoInvalidoException extends AcademicoException {
